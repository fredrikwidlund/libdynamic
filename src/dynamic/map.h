...
typedef size_t map_hash_callback(void *);
typedef int    map_equal_callback(void *, void *);
typedef void   map_set_callback(void *, void *);
typedef void   map_release_callback(void *);
